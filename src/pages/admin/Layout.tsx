        ...
        <Layout className="min-h-[100vh]">
            <Sider theme={'dark'} collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                ...
                <Menu
                    ...
                    onClick={() => setPageName(location.pathname)}
                />
            </Sider>
            ...
            <Layout>
                <div className="bg-white h-[80px] px-5 flex justify-between items-center shadow">
                    ...
                    <div>
                        <button
                            className={'border-2 py-2 px-5 rounded text-md flex items-center gap-3 font-medium hover:border-black hover:transition-[1s]'}
                            onClick={() => logOut()}>Log out <MdLogout/></button>
                    </div>
                </div>
